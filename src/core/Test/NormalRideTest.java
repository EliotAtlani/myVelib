...
public class NormalRideTest {


    @Test
    @DisplayName("Test of getting start/end station")
    public void testGettingStartStation(){
        ...
        DockingStation station4 = new DockingStation(position4, DockingStationStatus.ONLINE, DockingStationType.STANDARD,"Paris");
        ...
        DockingStation station6 = new DockingStation(position6, DockingStationStatus.ONLINE, DockingStationType.STANDARD,"Paris");
        ...
        NormalRide ride = new NormalRide(station1.getPosition(), station2.getPosition());
