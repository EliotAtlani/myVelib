...
public class RidePreferPlusStationTest {
    ...
    public void testFindEndStation(){
        ...
        DockingStation station4 = new DockingStation(position4, DockingStationStatus.ONLINE, DockingStationType.STANDARD,"Paris",10);
        station4.addParkingSlot(new ParkingSlot(station4));
        DockingStation station5 = new DockingStation(position5, DockingStationStatus.ONLINE, DockingStationType.PLUS,"Paris",10);
        station5.addParkingSlot(new ParkingSlot(station5));
        DockingStation station6 = new DockingStation(position6, DockingStationStatus.ONLINE, DockingStationType.STANDARD,"Paris",10);
        ...
        NormalRide ride = new RidePreferPlusStation(station1.getPosition(), station2.getPosition());
