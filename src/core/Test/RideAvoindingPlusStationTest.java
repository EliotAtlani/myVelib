...
public class RideAvoindingPlusStationTest {
    ...
    public void testFindEndStation(){
        ...
        DockingStation station1 = new DockingStation(position1, DockingStationStatus.ONLINE, DockingStationType.PLUS,"Paris");
        station1.addParkingSlot(new ParkingSlot(station1));
        DockingStation station2 = new DockingStation(position2, DockingStationStatus.ONLINE, DockingStationType.PLUS,"Paris");
        station2.addParkingSlot(new ParkingSlot(station2));
        DockingStation station3 = new DockingStation(position3, DockingStationStatus.ONLINE, DockingStationType.PLUS,"Paris");
        station3.addParkingSlot(new ParkingSlot(station3));
        DockingStation station4 = new DockingStation(position4, DockingStationStatus.ONLINE, DockingStationType.PLUS,"Paris");
        station4.addParkingSlot(new ParkingSlot(station4));
        DockingStation station5 = new DockingStation(position5, DockingStationStatus.ONLINE, DockingStationType.STANDARD,"Paris");
        station5.addParkingSlot(new ParkingSlot(station5));
        DockingStation station6 = new DockingStation(position6, DockingStationStatus.ONLINE, DockingStationType.PLUS,"Paris");
